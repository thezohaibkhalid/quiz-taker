...
const resultSchema = new mongoose.Schema(
  {
    attempt_id: { type: mongoose.Schema.Types.ObjectId, ref: "QtAttempt", required: true, unique: true },
...
export default mongoose.models.QtResult || mongoose.model("QtResult", resultSchema);
